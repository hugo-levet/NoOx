...
public class profileC extends Controller {
    ...
    public function __construct()
    {
        ...
        $mdp = currentUser.getMdp();
        $status = currentUser.getMdp();
        ...
        $firstConnexion = currentUser.getFirstConnexion();
        $lastConnexion = currentUser.getLastConnexion();
        $portrait = currentUser.getPortrait();
        $civility = currentUser.getCivility();
        $signature = currentUser.getSignature();
        $presentation = currentUser.getPresentation();
