...
<section id="navbarFPContainer">
    <nav id="charNavbar">
        <a class="charNavLink" href="/character/homepage&character=<?=$charID?>">
            <i class="far fa-address-card"></i>
            <p class="linkText">General</p>
        </a>
        <a class="charNavLink" href="/character/traits&character=<?=$charID?>">
            <i class="fas fa-users"></i>
            <p class="linkText">Traits</p>
        </a>
        <a class="charNavLink" href="/character/access&character=<?=$charID?>">
            <i class="fas fa-brain"></i>
            <p class="linkText">Accreditation</p>
        </a>
        <a class="charNavLink" href="/character/state&character=<?=$charID?>">
            <p id="etatIcon">
